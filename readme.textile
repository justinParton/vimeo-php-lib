...
h3. 1.   register for a developer key.
...
h3. 2.  install  phpCLI on the computer system you will be using. i used the installer for windows.
...
h3. 3. update your path variable to reflect the new php directory on your hard drive.
   <pre>          
